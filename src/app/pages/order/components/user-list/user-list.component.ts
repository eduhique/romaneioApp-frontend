...
export class UserListComponent implements OnInit, OnChanges {
  ...
  @Output()
  public userSelection: EventEmitter<User>;
  ...
  constructor(
    ...
    this.userSelection = new EventEmitter<User>();
  ...
  getSelectionLabel() {
    return this.selectedUser && this.selectedUser.id && this.selectedUser.name
      ? `${this.selectedUser.id} - ${this.selectedUser.name}`
      : '';
  }
  ...
  onSelect() {
    this.userSelection.emit(this.selectedUser);
  }
